...
#'
#' # service SAS for a container with read-only permissions
#' get_service_sas(bl, "containername")
#'
#' # service SAS for a container, allowing listing of blobs
#' get_service_sas(bl, "containername", permissions="rl")
#'
